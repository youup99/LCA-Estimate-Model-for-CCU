    ...
    <div>
      ...
      <el-form ref="form" :model="form" label-width="120px" label-position="left">
        <div class="row">
          <div class="col-md-4">
            <el-form-item label="Electricity" label-width="85px">
              <el-select v-model="form._defaultEmission.electricity.active" filterable>
                <el-option
          ...
          <div class="col-md-2">
            <el-form-item>
              <el-checkbox v-model="form._customEmission.electricity.use">Use Custom</el-checkbox>
            </el-form-item>
          </div>
          <div class="col-md-6">
            <el-form-item>
              <el-input type="number" v-model="form._customEmission.electricity.value">
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <el-form-item>
              <el-checkbox v-model="form._customEmission.heat.use">Use Custom</el-checkbox>
            </el-form-item>
          </div>
          <div class="col-md-6">
            <el-form-item>
        ...
        <div class="row">
          <div class="col-md-4">
            <el-form-item label="Steam" label-width="85px">
              <el-select v-model="form._defaultEmission.steam.active" filterable>
                <el-option
          ...
          <div class="col-md-2">
            <el-form-item>
              <el-checkbox v-model="form._customEmission.steam.use">Use Custom</el-checkbox>
            </el-form-item>
          </div>
          <div class="col-md-6">
            <el-form-item>
              <el-input type="number" v-model="form._customEmission.steam.value">
                <template slot="append">
                  kgCO2eq/
                  <br />MJ
                </template>
        ...
        <div class="row">
          <div class="col-md-4">
            <el-form-item label="Hydrogen" label-width="85px">
              <el-select v-model="form._defaultEmission.hydrogen.active" filterable>
                <el-option
          ...
          <div class="col-md-2">
            <el-form-item>
              <el-checkbox v-model="form._customEmission.hydrogen.use">Use Custom</el-checkbox>
            </el-form-item>
          </div>
          <div class="col-md-6">
            <el-form-item>
              <el-input type="number" v-model="form._customEmission.hydrogen.value">
                <template slot="append">
                  kgCO2eq/
                  <br />kg H2
                </template>
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <el-form-item>
              <el-checkbox v-model="form._customEmission.co2.use">Use Custom</el-checkbox>
            </el-form-item>
          </div>
          <div class="col-md-6">
            <el-form-item>
        ...
        <el-form-item>
          <el-tooltip class="item" effect="dark" placement="top">
            <div slot="content">
              The additional literature values presented in Figure 1
              <br />are not related to uncertainty. They are point estimates
              <br />based on different studies to demonstrate some of the
