...
import { pathwayTestItems } from "./items";
...
export default {
  ...
  data() {
    return {
      activeTabName: "first",
      activeTabLabel: "Sub-pathway 1 - Methanol",
      items: pathwayTestItems,
      subPathways: [],
      summary: []
    };
  },
  methods: {
    calculate() {
      ...
      this.subPathways.push(
        {
          name: "Sub-pathway 1 - Methanol",
          value: this.getMethanol()
        },
        {
          name: "Sub-pathway 2 - Methanol",
          value: this.getMethanol1()
        }
      );
      this.summary = this.getSummary();
      this.$store
        .dispatch("pathwayCalc/updatePathwayTest", {
          subPathways: this.subPathways,
          summary: this.summary
        })
        .then(() => {
          Event.$emit("summary", "pathwayTest");
        });
    },
    ...
    getMethanol() {
      // Sub-pathway 1 - Methanol - CO2 Converted
      ...
      // Sub-pathway 1 - Methanol - CO2 Unconverted
      ...
      // sub-pathway 1 - Methanol - CO2 Capture Process
      ...
      // sub-pathway 1 - Methanol - Methane Input
      var referenceAmount = 0.731072555205047;
      var intermediateAmount = referenceAmount;
      var activeAmount = this.pathwayTest.subpathway1.methanol.methane;
      var emission =
      ...
      // sub-patway 1 - Methanol - CO Emitted
      ...
      // sub-pathway 1 - Methanol - Thermal Consumption
      var referenceAmount = 4.62890310725552;
      var intermediateAmount = referenceAmount;
      var activeAmount = this.pathwayTest.subpathway1.methanol.heat;
      ...
      // sub-pathway 1 - Methanol - Electricity
      var referenceAmount = 0.203952143533123;
      var intermediateAmount = referenceAmount;
      var activeAmount = this.pathwayTest.subpathway1.methanol.electricity;
      ...
      // sub-pathway 1 - Methanol - End Use
    ...
    getMethanol1() {
      // sub-pathway 2 - Methanol - CO2 Converted
      ...
      // sub-pathway 2 - Methanol - CO2 Unconverted
      ...
      // sub-pathway 2 - Methanol - CO2 Capture Process
      var referenceAmount = this.co2;
      var intermediateAmount = referenceAmount;
      var activeAmount = intermediateAmount;
      var emission = activeAmount * (data0.activeAmount + data1.activeAmount);
      ...
      // sub-pathway 2 - Methanol - H2 Amount
      var referenceAmount = 0.0911047345767575;
      var intermediateAmount = referenceAmount;
      var activeAmount = this.pathwayTest.subpathway2.methanol.h2;
      ...
      // sub-pathway 2 - Methanol - Methane Input
      var referenceAmount = 0.332496413199426;
      var intermediateAmount = referenceAmount;
      var activeAmount = this.pathwayTest.subpathway2.methanol.methane;
      var emission =
        activeAmount * this.emissionFactors.upstreamEmissions.methane.mass;
      var data4 = {
        item: "Methane Input",
      ...
      // Sub-pathway 2 - Methanol - Thermal Consumption
      var referenceAmount = 3.43137529411765;
      var intermediateAmount = referenceAmount;
      var activeAmount = this.pathwayTest.subpathway2.methanol.heat;
      var emission = activeAmount * this.heat;
      var data5 = {
        item: "Thermal Consumption",
        referenceAmount: referenceAmount,
      ...
      // Sub-pathway 2 - Methanol - Electricity
      var referenceAmount = 0.291029246054519;
      var intermediateAmount = referenceAmount;
      var activeAmount = this.pathwayTest.subpathway2.methanol.electricity;
      var emission = activeAmount * this.electricity;
      var data6 = {
        item: "Electricity",
        referenceAmount: referenceAmount,
      ...
      // sub-pathway 2 - Methanol - End Use
      var referenceAmount = this.emissionFactors.fuelCycleEmissions.methanol
        .emission;
      var intermediateAmount = referenceAmount;
      var activeAmount = intermediateAmount;
    ...
    getSummary() {
      ...
      var data0 = {
        category: "Pathway Test",
        subCategory: "Sub-pathway 1",
        product: "Methanol",
