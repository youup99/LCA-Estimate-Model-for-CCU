export const defaultGeneralAssumptions = {
    defaultEmission: {
        ...
        heat: {
            list: ["Electrical heater + renewable", "Natural gas industrial furnace", "Combined heat & power"],
        ...
        hydrogen: {
            list: ["Electrolysis + low carbon electricity", "Steam methane reforming", "Coal gasification"],
        ...
        co2: {
            list: ["Direct air capture", "Natural gas power plant", "Coal power plant"],
