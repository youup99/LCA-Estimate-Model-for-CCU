...
const mutations = {
    ...
    resetMineralization(state) {
        Object.assign(state.mineralization, JSON.parse(JSON.stringify(defaultPathways.mineralization)))
    },
    resetBioconversion(state) {
        Object.assign(state.bioconversion, JSON.parse(JSON.stringify(defaultPathways.bioconversion)))
    },
    resetReductionLight(state) {
        Object.assign(state.reductionLight, JSON.parse(JSON.stringify(defaultPathways.reductionLight)))
    },
    resetReductionHydrogen(state) {
        Object.assign(state.reductionHydrogen, JSON.parse(JSON.stringify(defaultPathways.reductionHydrogen)))
    },
    resetReductionElectricity(state) {
        Object.assign(state.reductionElectricity, JSON.parse(JSON.stringify(defaultPathways.reductionElectricity)))
    },
    resetReductionHydrocarbon(state) {
        Object.assign(state.reductionHydrocarbon, JSON.parse(JSON.stringify(defaultPathways.reductionHydrocarbon)))
    },
}
